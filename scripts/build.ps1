...
$logoFull280 = Join-Path $repo 'assets\kimitolink-full-logo-280.png'
...
if (-not (Test-Path $logoFull280)) {
    Write-Error "Full logo (280px) not found: $logoFull280"
    exit 1
}
...
Copy-Item $logoFull280 (Join-Path $stage 'kimitolink-full-logo-280.png')
...
$distLogoFull280 = Join-Path $repo 'dist\kimitolink-full-logo-280.png'
...
Copy-Item $logoFull280 $distLogoFull280 -Force
